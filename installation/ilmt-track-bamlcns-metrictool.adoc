...
IBM® License Metric Tool generate reports to help you maintain compliance with your Virtual Processor Core (VPC) subcapacity license terms. 
...
For guidelines on installing ILMT, follow the link: https://www.ibm.com/support/pages/downloading-ibm-license-metric-tool-92

== Using and Configuring BAMOE ILMT Libraries

License Metric Tool automatically detects the following {PRODUCT_LONG} {VERSION_90X} release chargeable components that are part of the product:

|=== 
|Chargeable Software Components| Library

|Process Automation Manager Open Edition|ilmt-compliance-quarkus-pamoe
|Decision Manager Open Edition|ilmt-compliance-quarkus-dmoe
|===
